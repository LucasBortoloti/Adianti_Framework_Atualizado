...
class Pdfdois extends TPage
{
    ...
    function onGenerate($param)
    {
        try {
            ...
            $designer->writeAtAnchor('ano', ($ano->ano_lancamento));
            $designer->writeAtAnchor('avaliacoes', ($avaliacoes->quantidade_avaliacoes));
            $designer->writeAtAnchor('vendas', ($vendas->vendas));
            $designer->writeAtAnchor('bom', ($bom->avaliacoes));
