...
class Pdf extends TPage
{
    ...
    function onGenerate()
    {
        try {
            ...
            $designer->writeAtAnchor('nome', ('Lucas Bortoloti'));
            $designer->writeAtAnchor('dt', ('18/10/2003'));
            $designer->writeAtAnchor('hb', ('Jogar no pc'));
            $designer->writeAtAnchor('coracao', ('São Paulo FC'));
            $designer->writeAtAnchor('jogo', ('The Last of Us'));
            $designer->writeAtAnchor('xbox', ('Xbox'));
