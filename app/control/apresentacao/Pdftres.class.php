    ...
    public function onGenerate($param)
    {
        try {
            ...
            foreach ($produtosSelecionados as $produtoId) {
                ...
                $designer->writeAtAnchor('cliente', ('Lucas'));
                $designer->writeAtAnchor('codigo', ($produto->id));
                $designer->writeAtAnchor('produto', ($produto->nome));
                $designer->writeAtAnchor('preco', ($produto->preco));
